		...
		$(function () {
			...
			$("input.updateCount").change(function () {
				...
				if(confirm("确定要将"+ name +"商品数量修改为" + count + "吗？")){
					location.href = "http://localhost:8080/book1/cartServlet?action=updateCount&count=" + count + "&id=" + id;
				}else{
					//defaultValue是表单项Dom对象的属性，它表示默认的value的属性值
	...
	<div id="main">
		...
		<table>
			...
			<tr>
				...
				<td>
					<input class="updateCount" bookId="${entry.value.id}" type="text" style="width: 40px" value="${entry.value.count}"/>
				</td>
