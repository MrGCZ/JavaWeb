		...
		<script type="text/javascript">
			...
			$(function () {
				...
				$("#code_img").click(function () {
					//在事件响应的function中有一个this对象，这个this对象，是当前正在响应事件的dom对象
					this.src = "${basePath}kaptcha.jpg?d="+new Date(); //这里添加new Date()的原因：浏览器会把kaptcha.jpg缓存，每次一样的请求的话
					//浏览器就会调用缓存的数据，所以需要添加一个每次请求都不一样的数据
				})
